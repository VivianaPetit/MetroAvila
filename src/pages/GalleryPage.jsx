...
const GalleryPage = () => {
  const photos = [
    ...
    { src: 'path/to/photo9.jpg', alt: 'Photo 9' },
    { src: 'path/to/photo10.jpg', alt: 'Photo 10' },
    { src: 'path/to/photo11.jpg', alt: 'Photo 11' },
    ...
    <div className="gallery-page bg-[#F2F5E5] min-h-screen flex flex-col">
      ...
      <main className="flex-grow p-8">
        ...
        <div className="max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center">
          <div className="flex items-center justify-center bg-[#d9e4b1] rounded-lg shadow-md cursor-pointer hover:bg-[#c8d49a] transition-colors py-[1rem] w-[20rem] my-[1rem]">
